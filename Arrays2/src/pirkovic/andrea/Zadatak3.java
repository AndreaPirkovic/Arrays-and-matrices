	...
	public class Zadatak3 {
		public static void main(String[] args) throws Exception { 
			...
			double a = 0.0, xt = 0.0, yt = 0.0; DecimalFormat df = new DecimalFormat("#.###");
			...
			nizA[i] = Double.parseDouble(ulaz.readLine()); System.out.print("x[" + i + "] = ");
			x[i] = Double.parseDouble(ulaz.readLine()); System.out.print("y[" + i + "] = "); 
